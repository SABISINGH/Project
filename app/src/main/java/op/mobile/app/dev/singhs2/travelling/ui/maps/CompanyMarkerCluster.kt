...
/**
 *  CompanyMarkerCluster - The company (countries) marker clustering class helps to manage multiple markers
 *  at different zoom levels. This class helps us to put markers for all the tourists
 *  attractions.
 */
